...
public sealed class DamageTypeDefinitionLoaderTests
{
    [Fact]
    public void ValidDefinition_LoadsStrictly()
    {
        DamageTypeDefinition definition = Assert.Single(
            DamageTypeDefinitionLoader.LoadFromJson(
                """
                [
                  {
                    "id": "extension.damage-type.test",
                    "name": "Test",
                    "sources": [
                      {
